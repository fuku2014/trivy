...
type Flags struct {
	...
	//NIFCLOUDFlagGroup      *NIFCLOUDFlagGroup
...
func (f *Flags) groups() []FlagGroup {
	...
	//if f.NIFCLOUDFlagGroup != nil {
	//	groups = append(groups, f.NIFCLOUDFlagGroup)
	//}
...
func (f *Flags) ToOptions(appVersion string, args []string, globalFlags *GlobalFlagGroup, output io.Writer) (Options, error) {
	...
	//if f.NIFCLOUDFlagGroup != nil {
	//	opts.NIFCLOUDOptions = f.NIFCLOUDFlagGroup.ToOptions()
	//}
